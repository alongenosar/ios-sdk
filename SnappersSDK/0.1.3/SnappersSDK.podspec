Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :git => 'https://github.com/Snappers-tv/ios-sdk.git', :tag => '0.1.3' }
...
#pod lib lint --sources=https://alongenosar@bitbucket.org/eitan_goldfrad/wowzatrunk.git,https://github.com/CocoaPods/Specs.git --allow-warnings --verbose
# pod repo push SnappersSDK --sources=https://alongenosar@bitbucket.org/eitan_goldfrad/wowzatrunk.git,https://github.com/CocoaPods/Specs.git --allow-warnings --verbose
# pod repo push new_sdk --skip-import-validation --sources=https://alongenosar@bitbucket.org/eitan_goldfrad/wowzatrunk.git,https://github.com/CocoaPods/Specs.git --allow-warnings --verbose