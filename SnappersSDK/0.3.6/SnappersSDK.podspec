Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "9.0"
  s.source       = { :git => 'https://github.com/Snappers-tv/ios-sdk.git', :tag => '0.3.6' }
  s.vendored_frameworks = 'SnappersSDK.framework'
  s.dependency 'AWSS3'
  s.dependency 'SnappersEncoder'
  ...
  #s.subspec 'Firebase/Core'  do |sub| sub.dependency 'Firebase/Core', '~> 5.18.0' end
  #s.subspec 'Firebase/Auth'  do |sub| sub.dependency 'Firebase/Auth', '~> 5.18.0' end
  #s.subspec 'EVReflection'  do |sub| sub.dependency 'EVReflection', '5.8.0' end
  #s.subspec 'Kingfisher'  do |sub| sub.dependency 'Kingfisher', '5.1.1' end
  s.subspec 'FBSDKCoreKit'  do |sub| sub.dependency 'FBSDKCoreKit', '~> 4.40.0' end
  s.subspec 'FBSDKLoginKit' do |sub| sub.dependency 'FBSDKLoginKit', '~> 4.40.0' end
